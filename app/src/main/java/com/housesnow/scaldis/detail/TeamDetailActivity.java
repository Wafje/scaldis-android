...
public class TeamDetailActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setTitle(intent.getStringExtra("teamTitle"));
        ...
        mSectionsPagerAdapter = new SectionsPagerAdapter(getSupportFragmentManager(), intent.getStringExtra("teamName"), intent.getStringExtra("teamGuid"));
    ...
    public class SectionsPagerAdapter extends FragmentPagerAdapter {
        ...
        public SectionsPagerAdapter(FragmentManager fm, String teamName, String teamGuid) {
            super(fm);
